...
<link href="__ADMIN__/Admin/Css/mobile.css" rel="stylesheet" media="screen and(max-device-width:480px)"/>
<link href="__ADMIN__/Admin/Css/bootstrap.min.css" rel="stylesheet" type="text/css" />

<!--/*调用后台bootstrap样式*/-->
<link href="__ADMIN__/Admin/Css/aimee_login.css" rel="stylesheet" type="text/css" />
<!--/*调用后台综合样式表*/-->
...
<body>
<div class="header">
  <div class="login_logo"><img src="__ADMIN__/Admin/Images/login_logo.png" alt="" /></div>
</div>
<!-- 便捷通道 -->
...
#ie6warn p{float:left;background:url(__ADMIN__/Admin/Images/browser.png) no-repeat;margin:0;padding:0 0 0 40px;color:#fff;font:13px/30px Arial,SimSun;}
...
#weiphpBrowser li a{width:20px;height:20px;display:block;background:url(__ADMIN__/Admin/Images/browser.png) no-repeat;text-indent:-9999em;}
