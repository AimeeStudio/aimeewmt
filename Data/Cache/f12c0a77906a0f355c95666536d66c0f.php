...
<script type="text/javascript" src="__ADMIN__/Admin/Js/jquery.simpletip-1.3.1.js"></script>
<script type="text/javascript" src="__ADMIN__/Admin/Js/jquery.imgareaselect.pack.js"></script><!--剪接截取JS-->
<script type="text/javascript" src="__ADMIN__/Admin/Js/ajaxfileupload.js"></script><!--文件上传-->
<link href="__ADMIN__/Admin/Css/bootstrap.min.css" rel="stylesheet" type="text/css" />
<link href="__ADMIN__/Admin/Css/style.css" rel="stylesheet" type="text/css" />
<link href="__ADMIN__/Admin/Css/imgareaselect/imgareaselect-animated.css" rel="stylesheet" type="text/css" />
...
<div id="Container">
  ...
  <div id="Wrapper">
    ...
    <div id="right" class="Right">
      <div class="content">
    <iframe id="myframe" name="myframe" src="<?php echo U('Index/home');?>" frameborder="0" scrolling="no" onload="this.height=100" width="100%" ></iframe>
   </div>
    </div>
    <!--end Right--> 
  </div>
...
<script type="text/javascript">
	$("#header").load("<?php echo U('Index/header');?>");
	$("#left").load("<?php echo U('Index/left');?>");
  ...
  margin-bottom:10px;">
	<form name="form" action="" method="POST" enctype="multipart/form-data">
      ...
      <div style="float: left; width: 65%;">
        ...
        <img id="photo" src="__ADMIN__/Admin/Images/flower2.jpg" alt=""> </div>
      </div>
      
      <div style="float: left; width: 35%;">
        <div class="frame" style="margin: 0 1em; width: 100px; height: 100px;">
          <div id="preview" style="width: 100px; height: 100px; overflow: hidden;"> <img id="photoPr" src="__ADMIN__/Admin/Images/flower2.jpg" alt=""> </div>
        </div>
...
<script type="text/javascript">
	...
	function ajaxFileUpload()
	{
		...
		(
			{
				url:"<?php echo U('Common/imageUpload');?>",
				secureuri:false,
