 ...
 <li><a href="#">时间：<?php echo date("Y-m-d H:i:s"); ?></a></li>
        ...
        <!--文章内容开始-->
       	<div class="text-content">
        	<h3 class="red"><?php echo ($contentview["nr_name"]); ?></h3>
            <p>编辑 <?php echo ($contentview["nr_author"]); ?> / <?php echo (date("Y-m-d",$contentview["nr_times"])); ?></p>
             <?php echo ($contentview["nr_edit"]); ?>
        </div>
        <!--文章内容结束-->
        <!--中间结束-->
        <!--底部开始-->
