        	...
        	<table class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php if(is_array($pageList)): $i = 0; $__LIST__ = $pageList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pg): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="table_config"><a href="<?php echo U('Page/add_page?id='.$pg["id"]);?>">编辑</a><a href="<?php echo U('Page/del_page?id='.$pg["id"]);?>">删除</a><a href="<?php echo U('Page/page_view?id='.$pg["id"]);?>" target="_blank">预览</a></td>
